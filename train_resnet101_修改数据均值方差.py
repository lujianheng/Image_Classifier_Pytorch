...
if __name__=='__main__':
    ...
    finetune_net = models.resnet101(pretrained=True)
    ...
    epochs =100
    loss_ = 10
    save_root = r"./log_data_resnet101_meanstd/"
    writer = SummaryWriter('runs/experiment_resnet101_meanstd/')
    ...
    for t in range(epochs):
        ...
        WriteData(save_root + "resnet101.txt",
                  "epoch", t,
                  "train_loss", avg_loss,
                  ...
                  "val_f1", val_f1)
        if t % 10 == 0:
            torch.save(finetune_net.state_dict(), save_root + "resnet101_epoch" + str(t) + "_loss_" + str(avg_loss) + ".pth")
        torch.save(finetune_net.state_dict(), save_root + "resnet101_last.pth")
        if avg_loss < loss_:
            loss_ = avg_loss
            torch.save(finetune_net.state_dict(), save_root + "resnet101_best.pth")
