...
if __name__=='__main__':
    ...
    epochs =100
    loss_ = 10
    save_root = r"./log_data_resnet18/"
    writer = SummaryWriter('runs/experiment_resnet18/')
    ...
    for t in range(epochs):
        ...
        WriteData(save_root + "resnet18.txt",
                  "epoch", t,
                  "train_loss", avg_loss,
                  ...
                  "val_f1", val_f1)
        if t % 10 == 0:
            torch.save(finetune_net.state_dict(), save_root + "resnet18_epoch" + str(t) + "_loss_" + str(avg_loss) + ".pth")
        torch.save(finetune_net.state_dict(), save_root + "resnet18_last.pth")
        if avg_loss < loss_:
            loss_ = avg_loss
            torch.save(finetune_net.state_dict(), save_root + "resnet18_best.pth")
