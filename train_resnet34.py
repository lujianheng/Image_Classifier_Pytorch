...
if __name__=='__main__':
    ...
    for t in range(epochs):
        ...
        WriteData(save_root + "resnet34.txt",
                  "epoch", t,
                  "train_loss", avg_loss,
                  ...
                  "val_f1", val_f1)
        if t % 10 == 0:
            torch.save(finetune_net.state_dict(), save_root + "resnet34_epoch" + str(t) + "_loss_" + str(avg_loss) + ".pth")
        torch.save(finetune_net.state_dict(), save_root + "resnet34_last.pth")
        if avg_loss < loss_:
            loss_ = avg_loss
            torch.save(finetune_net.state_dict(), save_root + "resnet34_best.pth")
